...
{
    public class PagamentoPixTestes
    {
        private readonly PagamentoPix _subject;
        private readonly Mock<IPagamentoContext> _context;
        private readonly Mock<DbSet<Pagamento>> _mockDbSet;
        public PagamentoPixTestes()
        {
            _context = new Mock<IPagamentoContext>();
            _subject = new PagamentoPix(_context.Object);
        ...
        public async Task Should_Add_Pagamento()
        {
            ...
            var pagamentoPosDesconto = pagamento.Valor * 0.95M;
